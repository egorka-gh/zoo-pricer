...
var vm = new Vue({
    ...
    methods: {
        ...
        applyConfig: function() {
            ...
            this.ads.interval = (config.ads.interval && config.ads.interval > 5) ? config.ads.interval * 1000 : 5000;
            this.ads.showItems = (config.ads.items && config.ads.items > 2) ? config.ads.items : 2;
            //price
        ...
        syncAds: function(versions) {
            ...
            fs.readdir(folder, (err, files) => {
                ...
                files.forEach(element => {
                    newItems.push({ name: element, path: "file://" + path.join(this.ads.folder, versions.ads, element) });
                });
